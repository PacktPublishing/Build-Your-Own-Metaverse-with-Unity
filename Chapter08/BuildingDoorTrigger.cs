...
public class BuildingDoorTrigger : MonoBehaviour, IPlayerActions
{
    ...
    public async void MintNft()
    {
        ...
        CreateRedeemVoucherModel.CreateVoucher721 voucher721 =
            new CreateRedeemVoucherModel.CreateVoucher721();
        ...
        RedeemVoucherTxModel.Response voucherResponse = await EVM.CreateRedeemTransaction(
            chain,
            network,
            voucherArgs,
            type,
            nft,
            voucherResponse721.receiver
        );
