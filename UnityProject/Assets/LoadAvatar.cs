...
public class LoadAvatar : MonoBehaviour
{
    ...
    public void ChangeAvatar()
    {
        ...
        GameObject avatarInstance = Instantiate(Resources.Load("Prefabs/Avatars/" + avatarName), oldAvatar.transform.position, oldAvatar.transform.rotation) as GameObject;
